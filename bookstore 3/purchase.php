...
?>
	<table class="table">
		...
		<!-- loop through each cart item as get the fields -->
	    	<?php
		...
		<tr>
			...
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td><?php echo "" .  $_SESSION['total_items']*3 + ($total_qty -  $_SESSION['total_items']); ?></td>
		</tr>
		<tr>
	...
	<form method="post" action="process.php" class="form-horizontal">
        ...
        <div class="form-group">
            <label for="card_PID" class="col-lg-2 control-label">PIN</label>
            <div class="col-lg-10">
	...
	<!-- Note -->
	<p class="text-danger">Note: Use any random values on the fields given above.</p>
<?php
	} else {
