		...
		foreach($_SESSION['cart'] as $isbn =>$qty){
			if($_POST[$isbn] == '0'){
                ...
                foreach ($_SESSION['cart'] as $isbn => $qty) {
					...
					echo $_POST["$isbn"];
					if($_POST["$isbn"] > $book['quantity']){
						$msg = '<div class="alert alert-warning">Sorry!! we are unable to process your request.</div>';
						// echo "Sorry!! we are unable to process your request. Please reduce your card item";
